	...
	<form action="<?php echo $_SERVER['PHP_SELF']; ?>" method="post" class="text-center">
		<fieldset>
			<label for="id_nom">Produit : </label>
				<input type="text" name="NomP" id="id_nom" placeholder="Nom" required size="20"/><br />
			<label for="id_prix">Prix : </label>
				<input type="number" step="0.01" name="prix" id="id_produit" placeholder="Prix" required size="20"/><br />
			<label for="id_illustration">Illustration (.jpg) : </label>
				<input type="text" name="illustration" id="id_illustration" placeholder="Illustration" required size="20"/><br />
...
function FormulaireSuppressionProduit(){
	...
	<form action="<?php echo $_SERVER['PHP_SELF']; ?>" method="post" class="text-center">
		<fieldset>
			...
			<input type="number" step="1" name="idP" id="idP" placeholder="Id produit" required size="20" /><br />
