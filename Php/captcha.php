...
$lignes=4;//nombre de lignes multicolore qui seront affichées avec le code (10 est bien)
$caracteres="abcdefghijklmnopqrstuvwxyzABCDEFGHIJKLMNOPQRSTUVWXYZ0123456789";//type de caractère du code qui sera affiché dans l'image
...
for($i=0;$i<=$lignes;$i++){
    $rgb=hexargb(substr(str_shuffle("abcdefghijklmnopqrstuvwxyzABCDEFGHIJKLMNOPQRSTUVWXYZ0123456789"),0,6));//choisi une couleur aléatoirement (str_shuffle), de 6 caractères (substr(chaine,0,6)) avec la sélection alphanumérique
